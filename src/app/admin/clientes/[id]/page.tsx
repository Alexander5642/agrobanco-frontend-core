          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div className="flex flex-col">
              {movimientos.length === 0 ? (
                <div className="p-8 text-center text-gray-500 text-sm">El cliente no tiene movimientos.</div>
              ) : (
                movimientos.map((mov) => (
                  <div key={mov.id} className="p-4 border-b border-gray-50 flex items-center justify-between hover:bg-gray-50 transition-colors">
                    ...
                    <p className={`font-bold text-sm ${mov.es_ingreso ? 'text-brand' : 'text-red-500'}`}>
